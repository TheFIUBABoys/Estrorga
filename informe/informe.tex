...
Tambi\'en se encarga de administrar los sistemas de seguridad e higiene relacionados con la producci\'on. Para esto deber\'a estar informado de los costos de la fabricación del producto.Por lo tanto, organiza e implementa los sistemas de costeo.
	...
	\begin{enumerate}
			...
			\begin{itemize}
				\item \textbf{Entradas}:
				\begin{enumerate}
					\item Pedido del cliente.
					\item Productos para entrega.
					\item Personal.
				\end{enumerate}
				\item \textbf{Salidas}:
				Las salidas son el resultado de la utilización de los recursos para lograr el servicio de entrega.
				\item \textbf{Procesos}:
				\begin{enumerate}[resume]
					\item Recepción de pedidos.
					\item Planificación de entrega.
					\item Carga y despacho de los productos.
					\item Realización de reportes de entrega y planillas de devoluciones.
					\item Al finalizar el mes, se realiza un inventario físico.
				\end{enumerate}
				\item \textbf{Retroalimentaci\'ion}:
La retroalimentación se logra a través de los reportes diarios, semanales y mensuales y la existencia de dispositivos de control.
				\item \textbf{Ambiente}:
El ambiente comprende todo fuera de la organización: la naturaleza de sus productos, clientes y competidores; su establecimiento geográfico; el clima económico, político, etc.
La empresa reside en una zona residencial de la provincia de Buenos Aires, muy cerca del ingreso de dos importantes rutas que unen la ciudad con otros grandes centros del país, siendo este un punto estratégico para la distribución, sirviendo inclusive a las zonas patagónicas y del litoral. También cuenta con sucursales en Mar del Plata, Bahía Blanca, Córdoba y Tucumán.			
			\end{itemize}
		
			
			\item \textit{¿Cúal es el problema evidente que enfrenta la empresa}\\
			1. Se ve una falta en la estructura organizacional de la empresa, notándose en un principio, la necesidad de una creación de algunos sectores para mejorar el funcionamiento de la misma.
2. El desconocimiento de los mandos medios sobre la calidad del servicio, los lleva a interpretar erróneamente sobre la misma.
3. La comunicación en la empresa era mala y la disposición de los distintos mandos para mejorar la misma era mínima.
4. La falta de un buen control sobre la devolución de los productos, y una incorrecta información en los motivos por los cuales el producto no había podido entregarse, ó había sido rechazado por el cliente. Esto impedía poder corregir y mejorar el resultado buscado.
5. Diferencias en la identificación de los componentes de los costos de distribución y un mal manejo del sistema de verificación de créditos por la falta de un sistema unificado mediante una red interna.		
			
			\item \textit{¿Cúal es la parte de la estructura que surge como clave?}\\
			La parte de la estructura que surge como clave es la línea media. La cadena corre de los gerentes a los administradores y supervisores, quienes controlaban el proceso de distribución de los productos, realizado por terceros, con compañía de gente de la empresa. El gerente de línea media recoge información retroalimentada en el desempeño de la unidad y a partir de la misma, toma las decisiones pertinentes al cargo.

			
			\item \textit{¿Cúal es el mecanismo de coordinación preponderante y por qué?}\\
			El mecanismo coordinador preponderante es el de supervisión directa.Se consigue la coordinación mediante supervisión directa cuando una persona se responsabiliza del trabajo de los demás, quien les dará instrucciones y controlará sus acciones.
						
			\item \textit{Dibujar el organigrama actual de la companía}\\
						
			\item \textit{Mencionar la descripción de uno de los cargos}\\
			Gerente de Distribución: se encarga de coordinar la distribución a tiempo de los productos y de la asignación a los distintos repartidores, tanto de la empresa contratista como de los repartidores independientes.
Además debe supervisar y controlar los informes que le devuelven los repartidores una vez finalizada la distribución de los productos.
También debe asegurar la calidad de la distribución, es decir el mantenimiento de los transportes utilizados para la distribución, la correcta llegada en tiempo y forma de los productos, etc.

						
			\item \textit{Mencionar que tipo de configuración estructural se adapta mejor a la organización de referencia}\\
			El tipo de configuración estructural que mejor se adapta a esta organización es la estructura lineal debido a las características de la empresa.
